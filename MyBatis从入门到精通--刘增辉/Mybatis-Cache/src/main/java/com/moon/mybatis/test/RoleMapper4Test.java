...
import com.moon.mybatis.mapper.SysRoleMapper4;
import com.moon.mybatis.pojo.SysRole4;

/**
 * 由于目前本机没有部署Redis服务，该类没有进行过测试。
 * 
 * @author moon  2019/08/25  19:01  
 *
 */
public class RoleMapper4Test extends BaseMapper {
	
	
	/**
	 * 使用mybatis-redis验证MyBatis二级缓存
	 * 
	 * @author moon  2019/08/25  18:59  
	 */
	@Test
	public void testEhcache() {
		...
		try {
			...
			// 获取SysRoleMapper3接口
			SysRoleMapper4 roleMapper = sqlSession.getMapper(SysRoleMapper4.class);
			...
			// 再次查询获取 id=3 的角色
			SysRole4 role2 = roleMapper.selectRoleById(3L);
		...
		try {
			...
			SysRole4 role22 = roleMapper.selectRoleById(3L);
			...
			// 获取 role3
			SysRole4 role3 = roleMapper.selectRoleById(3L);
