 ...
 * 
 * 若要使用ehcache-cache实现 MyBatis的二级缓存，MyBatis需要使用Serializable序列化缓存。
 * 该缓存类要求所有被序列化的对象必须实现Serializable(java.io.Serializable)接口。
 * 
 * @author moon  2019/08/18  17:09
 *
 */
public class SysRole3 implements Serializable {
     ...
     * @param createTime
     */
	public SysRole3(Long id, String roleName, Integer enabled, Long createBy, Date createTime) {
		super();
		this.id = id;
