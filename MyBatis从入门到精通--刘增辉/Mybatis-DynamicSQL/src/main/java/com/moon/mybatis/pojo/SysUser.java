...
public class SysUser {
	 ...
	 * @param createTime
	 * 
	 * @author moon  2019/02/15  17:26   
	 */
	public SysUser(String userName, String userPassword, String userInfo, byte[] headImg, Date createTime) {
		super();
	 ...
	 * @param createTime
	 * 
	 * @author moon  2019/02/15  17:17  
	 */
	public SysUser(String userName, String userPassword, String userEmail, String userInfo, byte[] headImg,
			Date createTime) {
		super();
		this.userName = userName;
		this.userPassword = userPassword;
